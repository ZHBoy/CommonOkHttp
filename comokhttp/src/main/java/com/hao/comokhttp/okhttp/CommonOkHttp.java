package com.hao.comokhttp.okhttp;

import android.content.Context;
import android.os.Handler;

import com.google.gson.Gson;
import com.hao.comokhttp.body.ProgressRequestBody;
import com.hao.comokhttp.body.ResponseProgressBody;
import com.hao.comokhttp.response.DownloadResponseHandler;
import com.hao.comokhttp.response.GsonResponseHandler;
import com.hao.comokhttp.response.IResponseHandler;
import com.hao.comokhttp.response.JsonResponseHandler;
import com.hao.comokhttp.response.RawResponseHandler;
import com.hao.comokhttp.util.LogUtils;
...
/**
* @作者 hao
* @创建日期 2018-7-24 16:10
* Description: 封装Okhttp
*/
public class CommonOkHttp {

    private OkHttpClient client;
    private static CommonOkHttp instance;
     ...
     * @return
     */
    public static CommonOkHttp get() {
        if(instance == null) {
            instance = new CommonOkHttp();
        }
